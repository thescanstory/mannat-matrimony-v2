...
export const MOCK_PROFILES: Profile[] = [
  ...
  },
  {
    ...
    sub_community: 'Singhania',
    caste: 'Rajput',
    mother_tongue: 'Hindi',
    city: 'Delhi NCR & Mumbai',
    salary_bracket: '₹50L+ HNI',
    income_bracket: '50+',
    diet: 'Veg',
    occupation: 'Founder & Managing Director',
    company_name: 'GreenTech Logistics',
    bio_video_url: 'https://assets.mixkit.co/videos/preview/mixkit-young-man-talking-to-the-camera-41132-large.mp4',
    photos: [
    ...
    gun_milan_score: 33,
    is_unlocked: true,
    education: 'B.Tech IIT Delhi, M.S. Stanford University',
    height: "6'0\"",
    phone_number: '+91 98111 22334',
    location_intent: 'Open to Long Distance',
    bio_text: 'Building sustainable supply chains. Passionate about road cycling, contemporary Indian art, and family Sunday brunches.',
    family_background: 'Father is an Industrialist based in Delhi NCR, Mother is a Philanthropist. High cultural grounding and progressive values.',
    marriage_expectations: 'Looking for an ambitious, kind partner with strong cultural values and shared enthusiasm for continuous self-growth.',
    lifestyle_details: {
      travel_freq: '4+ times a year',
      second_home: true,
      private_clubs: 'Delhi Gymkhana Club',
      net_worth: '₹15Cr+'
    },
    horoscope: {
      manglik: 'No',
  ...
  },
  {
    ...
    sub_community: 'Vadama Iyer',
    caste: 'Brahmin',
    mother_tongue: 'Tamil',
    city: 'Chennai & Bengaluru',
    salary_bracket: '₹15L - ₹25L',
    income_bracket: '15-25',
    diet: 'Veg',
    occupation: 'Architect & Urban Designer',
    company_name: 'Studio Lotus',
    bio_video_url: 'https://assets.mixkit.co/videos/preview/mixkit-young-woman-smiling-at-the-camera-41130-large.mp4',
    photos: [
      'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=400&q=80',
      'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=400&q=80',
    ...
    gun_milan_score: 31,
    is_unlocked: true,
    education: 'B.Arch CEPT University, M.Arch Bartlett London',
    height: "5'6\"",
    phone_number: '+91 97777 88899',
    location_intent: 'Only Same City',
    bio_text: 'Passionate about sustainable architecture, Carnatic vocal music, and heritage restoration.',
    family_background: 'Traditional Tamil Brahmin family settled in Chennai. Father is a Senior Cardiologist, Mother is a Carnatic Musician.',
    marriage_expectations: 'Looking for a culturally grounded partner who appreciates arts, deep conversations, and mutual respect in a marriage.',
    lifestyle_details: {
      travel_freq: '2-3 times a year',
      second_home: true,
      private_clubs: 'Madras Club',
      net_worth: '₹5Cr - ₹10Cr'
    },
    horoscope: {
      manglik: 'No',
