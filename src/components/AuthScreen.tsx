...
export const AuthScreen: React.FC<AuthScreenProps> = ({ onLoginSuccess, onOpenLanding }) => {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#F8F6F2] flex flex-col justify-start pt-[max(1.25rem,env(safe-area-inset-top))] pb-[max(1.25rem,env(safe-area-inset-bottom))] px-4 select-none max-w-sm mx-auto relative font-sans text-[#161412] text-left gap-4">
      ...
      <div className="pt-2 space-y-1 text-center">
        <div className="flex flex-col items-center">
          ...
          <span className="text-3xl font-normal tracking-[0.24em] uppercase text-[#560406] leading-tight" style={{ fontFamily: "'Cormorant Garamond', 'Playfair Display', Georgia, serif" }}>
            MANNAT
          </span>
          <span className="text-[8px] uppercase tracking-[0.34em] font-bold text-[#A17B5E] mt-0.5">
            Bespoke Matchmaking
          </span>
        </div>
        <h1 className="text-xl font-bold text-[#161412] pt-2" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif" }}>
          Sign In to Your Account
        </h1>
        <p className="text-[11px] text-[#6E6259] font-medium leading-normal">
          The intention-first Indian matrimonial network with verified bio-datas.
        </p>
      </div>

      {/* Main Interactive Login Section */}
      <div className="bg-white border border-[#E8DDD0] rounded-3xl p-4 sm:p-5 space-y-3.5 shadow-sm w-full">
        ...
        <form onSubmit={handleCustomSignIn} className="space-y-3">
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-8 pr-3 py-2.5 rounded-xl bg-[#F8F6F2] border border-[#E8DDD0] text-xs font-bold text-[#161412] outline-none focus:ring-2 focus:ring-[#560406] transition-colors"
              />
              <Mail className="w-3.5 h-3.5 text-[#A17B5E] absolute left-3 top-3" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-8 pr-3 py-2.5 rounded-xl bg-[#F8F6F2] border border-[#E8DDD0] text-xs font-bold text-[#161412] outline-none focus:ring-2 focus:ring-[#560406] transition-colors"
              />
              <User className="w-3.5 h-3.5 text-[#A17B5E] absolute left-3 top-3" />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 px-5 rounded-xl bg-gradient-to-r from-[#730C0F] via-[#560406] to-[#3A0204] hover:brightness-110 active:scale-95 text-xs font-bold text-[#F5E6D3] border border-[#A17B5E]/40 flex items-center justify-center gap-2 transition-all cursor-pointer shadow-md mt-1 whitespace-nowrap"
          >
            <LogIn className="w-3.5 h-3.5 text-[#D8B486]" />
            <span className="whitespace-nowrap">{loading ? 'Signing in...' : 'Sign In with Email'}</span>
            <ArrowRight className="w-3.5 h-3.5 ml-1 text-[#D8B486]" />
          </button>
        </form>
        ...
        <div className="flex items-center gap-2.5 pt-0.5">
          ...
          <span className="text-[9px] font-black uppercase tracking-wider text-[#A17B5E]">OR</span>
          <div className="flex-1 h-px bg-[#E8DDD0]" />
        </div>
        ...
        <div className="space-y-2">
          ...
          <button
            ...
            className="w-full py-2.5 px-4 rounded-xl bg-white hover:bg-[#F8F6F2] active:scale-95 text-xs font-bold text-[#161412] border border-[#E8DDD0] flex items-center justify-center gap-2.5 transition-all cursor-pointer shadow-xs whitespace-nowrap"
          >
